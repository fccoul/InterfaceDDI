...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Affichage _MENU_ ", sZeroRecords: "Aucune correspondance trouvée", sEmptyTable: "Aucun résultat trouvé", sInfo: "Affichage _START_ a _END_ / _TOTAL_ elements", sInfoEmpty: "Affichage 0 à 0 / 0 elements", sInfoFiltered: "(filtre sur _MAX_ elements)", sInfoPostFix: "", sSearch: "Recherche:", sUrl: "", oPaginate: { sFirst: "First", sPrevious: "Previous", sNext: "Next", sLast: "Last" }, fnInfoCallback: null
...
a + ""; a = b.split(""); var c = ""; b = b.length; for (var d = 0; d < b; d++) { if (d % 3 === 0 && d !== 0) c = "," + c; c = a[b - d - 1] + c } 
            ...
            }; this.aLengthMenu = [5,10, 25, 50, 100]; this.bDrawing = this.iDraw = 0; this.iDrawError = -1; this._iDisplayLength = 5; this._iDisplayStart = 0; this._iDisplayEnd = 5; this._iRecordsDisplay = this._iRecordsTotal = 0; this.bJUI = false; this.oClasses = n.oStdClasses; this.bSorted = this.bFiltered = false; this.oInit = null
        } function r(a) {
            return function () {
