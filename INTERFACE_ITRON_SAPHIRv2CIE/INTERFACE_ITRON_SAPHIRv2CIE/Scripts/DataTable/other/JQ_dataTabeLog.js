    ...
    var S = function (h) {
        ...
        "row().child().remove()"], function () { bb(this); return this }); p("row().child.isShown()", function () { var a = this.context; return a.length && this.length ? a[0].aoData[this[0]]._detailsShow || !1 : !1 }); var dc = /^(.+):(name|visIdx|visible)$/, Wb = function (a, b, c, d, e) { for (var c = [], d = 0, f = e.length; d < f; d++) c.push(B(a, e[d], b)); return c }; p("columns()", function (a, b) {
            ...
            fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "<<", sLast: ">>", sNext: ">", sPrevious: "<" }, sEmptyTable: "Aucune données disponibles", sInfo: "Affichage _START_ à _END_ / _TOTAL_ elements", sInfoEmpty: "Affichage 0 à 0 / 0 elements", sInfoFiltered: "(filtre sur _MAX_ total elements)",
                sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Affichage _MENU_ elements", sLoadingRecords: "Chargement...", sProcessing: "Processing...", sSearch: "Recherche:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "Aucune correspondance trouvée"
