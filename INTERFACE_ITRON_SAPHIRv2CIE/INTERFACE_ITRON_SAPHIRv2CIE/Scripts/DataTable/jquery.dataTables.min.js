...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"<<",sLast:">>",sNext:">",sPrevious:"<"},sEmptyTable:"Aucune connées disponibles",sInfo:"Affichage _START_ to _END_ of _TOTAL_ elements",sInfoEmpty:"Affichage 0 to 0 of 0 elements",sInfoFiltered:"(filtré sur un total de _MAX_  elements)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichage _MENU_ elements",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune donnée trouvée"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
